...
$vega_wp_defaults['vega_wp_frontpage_4_cols_read_more'] = __('ПОДРОБНЕЕ', 'vega');
...
$vega_wp_defaults['vega_wp_blog_feed_readmore_text'] = 'Подробнее';
$vega_wp_defaults['vega_wp_blog_feed_comment_text'] = 'Комментарий';
$vega_wp_defaults['vega_wp_blog_feed_comments_text'] = 'Комментариев';
$vega_wp_defaults['vega_wp_blog_feed_nocomments_text'] = 'Комментировать';
...
$vega_wp_defaults['vega_wp_footer_credit_message'] = __('<a target="_blank" href="https://www.lyrathemes.com">LyraThemes</a> / <a href="http://wp-templates.ru/" title="Шаблоны WordPress">WP</a> / <a href="http://builderbody.ru/" title="Бодибилдинг и фитнес - упражнения, тренировки, спортивное питание" target="_blank">Fitness</a>', 'vega');
