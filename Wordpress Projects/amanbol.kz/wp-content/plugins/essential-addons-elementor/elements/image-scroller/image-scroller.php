...
class Widget_Eael_Image_Scroller extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        echo '<div class="' . implode(' ', $wrap_classes) . '">
			<img src="' . $settings['eael_image_scroller_bg_img']['url'] . '">
		</div>';
    }
}

Plugin::instance()->widgets_manager->register_widget_type(new Widget_Eael_Image_Scroller());
