...
// WP-Optimize advanced-cache.php (written by version: 3.0.12) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/var/www/vhosts/amanbol.kz/httpdocs/wp-content/plugins/wp-optimize/cache',
);
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/var/www/vhosts/amanbol.kz/httpdocs/wp-content/plugins/wp-optimize/cache/extensions');
}

if (!@file_exists(WPO_CACHE_CONFIG_DIR . '/config-amanbol.kz.php')) { return; }

$GLOBALS['wpo_cache_config'] = json_decode(file_get_contents(WPO_CACHE_CONFIG_DIR . '/config-amanbol.kz.php'), true);
